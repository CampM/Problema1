...
NOTAS: DESCOMENTAR VALIDACION DE DATOS DE EDICION

Errores:(
)

Cambios:(
vista de lista de ofertas (Diferenciar psicologo de administrador)
)
...
Mejora Practica:(
boostrap
Gestion de  usuarios (Modificar, Añadir, Eliminar, Listar)
instalacion/Documentacion/"Git"
)
